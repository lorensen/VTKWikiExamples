...
vtkStandardNewMacro(vtkTestMultipleOutputConnectionsFilter);

/*
int vtkTestMultipleOutputConnectionsFilter::FillOutputPortInformation( int port, vtkInformation* info )
{
  if(port == 0)
  {
...
int vtkTestMultipleOutputConnectionsFilter::RequestData(vtkInformation *vtkNotUsed(request),
...
int vtkTestMultipleOutputConnectionsFilter::RequestDataObject(
  vtkInformation*,
  vtkInformationVector** inputVector ,
  vtkInformationVector* outputVector)
{
